...
// Lesson 1
@synthesize lesson_1A;

// Lesson 2
@synthesize lesson_2A,lesson_2B,lesson_2C,lesson_2D,lesson_2E;

- (NSArray *)getLessonWithID:(int)lesson_ID {
    
    NSArray *selectedArray = [[NSArray alloc]init];
    switch (lesson_ID) {
        case 1: selectedArray = lesson_1A;
            break;
...
- (id)init {
    ...
    if (self) {
        ...
        // Image Arrays
        lesson_1A = @[@"symbol_1.png",@"symbol_2.png",@"symbol_3.png",@"symbol_4.png",@"symbol_5.png",@"symbol_6.png",@"symbol_7.png",@"symbol_8.png",@"symbol_9.png",@"symbol_10.png"];
